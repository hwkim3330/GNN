...
# --- 1단계: 데이터 생성 및 모방학습 ---
DATASET_PATH = "ilp_dataset_transformer.pt"
NUM_DATA_SAMPLES = 5000000; ILP_TIME_LIMIT_SEC = 45; NUM_PRODUCERS = max(1, mp.cpu_count() - 2)
IMITATION_EPOCHS = 50; IMITATION_BATCH_SIZE = 128; IMITATION_LR = 1e-4
IMITATION_MODEL_PATH = "transformer_imitator.pth"

# --- 2단계: PPO 강화학습 ---
RL_EPISODES = 1000000; RL_LR = 3e-5; GAMMA = 0.99; EPS_CLIP = 0.2
K_EPOCHS = 10; UPDATE_TIMESTEP = 20

# --- 모델 및 벤치마크 ---
FINAL_MODEL_PATH = "gnn_transformer_ppo_final.pth"
BENCHMARK_SCENARIOS = 20; RESULT_PLOT_PATH = "benchmark_results_transformer_ppo.png"
...
class GNN_PPOSolver(BaseSolver):
    def __init__(self, model_path):
        ...
        self.agent = PPOAgent(3, 128, 0, 0, 0, 0)
...
def run_full_procedure_and_benchmark():
    ...
    ppo_agent = PPOAgent(3, 128, RL_LR, GAMMA, EPS_CLIP, K_EPOCHS)
