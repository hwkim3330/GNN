...
# 0. 설정
# ==============================================================================
IMITATION_ITERATIONS = 500000; IMITATION_LR = 1e-4; IMITATION_MODEL_PATH = "gnn_imitated_transformer.pth"
ONLINE_EPISODES = 200000; ONLINE_LR_RL = 1e-6; ONLINE_LR_IMITATION = 5e-6; RL_EXPLORATION_COUNT = 5; ILP_TIME_LIMIT_SEC = 60
